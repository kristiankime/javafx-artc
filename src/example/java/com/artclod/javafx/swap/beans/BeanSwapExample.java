...
public class BeanSwapExample extends Application {
	...
	public Parent createApplication() {
		...
		aField.textProperty().bindBidirectional(beanSwap.propertyFrom(StringBean.GET_A_PROPERTY));
		TextField bField = new TextField();
		bField.textProperty().bindBidirectional(beanSwap.propertyFrom(StringBean.GET_B_PROPERTY));
